...
if __name__ == "__main__":
    ...
    checkpoint_callback = ModelCheckpoint(monitor='val_em',
                                        save_top_k=1,
                                        save_last=True,
    ...
    def sweep_train(config=None):
            ...
            dataloader = Dataloader(cfg.model.model_name, config.batch_size, cfg.data.shuffle, cfg.path.train_path,cfg.train.seed,
                            cfg.path.test_path)
